...
void Bot::set_api(Phoenix::Api* api) {
    m_api = api;
}

void Bot::set_scene(Scene* scene) {
    m_scene = scene;
}
void Bot::handle_key_press(char key) {
    if (key == ';') {
        // Kod do prze³¹czania widocznoœci okna PhoenixBot
    }
}
